...
public class ThresholdOccursToSpreadsheet {
    ...
    public void go(File spreadsheetOut, Collection<ThresholdOccur> thresholdOccurs) {
        try {
            File odsOutFile = spreadsheetOut;
            OdfSpreadsheetDocument spreadsheet = OdfSpreadsheetDocument.newSpreadsheetDocument();
            OdfTable thresholdOccursTable = OdfTable.newTable(spreadsheet);
            thresholdOccursTable.setTableName("");
